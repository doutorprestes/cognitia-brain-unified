# Issue #6 — Active Learning Loop (Feedback Inline)

**Labels:** `fase-4`, `ml`, `telegram`, `active-learning`
**Estimate:** 1h

## Descrição

Implementar coleta de feedback via botões inline no Telegram (👍/👎) para alimentar o classificador.
...
- [ ] Implementar `obter_itens_incertos() → list` (para retreinamento)
...
4. Mensagem é atualizada com confirmação
