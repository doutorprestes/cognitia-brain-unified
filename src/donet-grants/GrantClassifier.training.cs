...
{
    public partial class GrantClassifier
    {
        public const string RetrainFilePath =  @"C:\Users\jpres\source\repos\BuscadorDeEditais\Grant_finder\Grant_finder\grant-data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"Title", @"Title"),new InputOutputColumnPair(@"FonteDeRecurso", @"FonteDeRecurso"),new InputOutputColumnPair(@"PublicoAlvo", @"PublicoAlvo")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"Title",@"FonteDeRecurso",@"PublicoAlvo"}))      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator: mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options(){L1Regularization=0.0735622F,L2Regularization=0.2515345F,LabelColumnName=@"Category",FeatureColumnName=@"Features"}), labelColumnName:@"Category"))      
