...
namespace Grant_finder
{
    ...
    {
        /// <summary>
        /// model input class for GrantClassifier.
        /// </summary>
        ...
        /// <summary>
        /// model output class for GrantClassifier.
        /// </summary>
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"FonteDeRecurso")]
            public float[] FonteDeRecurso { get; set; }

            [ColumnName(@"PublicoAlvo")]
            public float[] PublicoAlvo { get; set; }
        ...
        private static string MLNetModelPath = Path.GetFullPath("GrantClassifier.mlnet");
