...
import { fetchOpportunitiesWithCpp } from "./scrapers/cpp_bridge.js";
...
async function main(): Promise<void> {
  logger.info("Starting GrantWatch pipeline");
  ...
  const collectorSpecs = [
    { name: "FINEP", fetcher: () => fetchOpportunitiesWithCpp("FINEP").catch(() => fetchFinepOpportunities()) },
    { name: "CNPq", fetcher: fetchCnpqOpportunities },
    { name: "FAPESP", fetcher: () => fetchOpportunitiesWithCpp("FAPESP").catch(() => fetchFapespOpportunities()) },
